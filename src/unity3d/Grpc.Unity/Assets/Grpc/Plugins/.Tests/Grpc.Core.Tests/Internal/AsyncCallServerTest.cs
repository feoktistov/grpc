...
namespace Grpc.Core.Internal.Tests
{
    ...
    public class AsyncCallServerTest
    {
        ...
        public void WriteCompletionFailureThrows()
        {
            ...
            AsyncAssert.ThrowsAsync(typeof(IOException), async () => await writeTask);
        ...
        public void WriteAndWriteStatusCanRunConcurrently()
        {
            ...
            AsyncAssert.DoesNotThrowAsync(async () => await writeTask);
            AsyncAssert.DoesNotThrowAsync(async () => await writeStatusTask);
        ...
        public void WriteAfterWriteStatusThrowsInvalidOperationException()
        {
            ...
            AsyncAssert.ThrowsAsync(typeof(InvalidOperationException), async () => await responseStream.WriteAsync("request1"));
