...
namespace Grpc.Core.Tests
{
    public class MarshallingErrorsTest
    {
        ...
        {
            AsyncAssert.ThrowsAsync<IOException>(async () => await Calls.AsyncUnaryCall(helper.CreateUnaryCall(), "UNSERIALIZABLE_VALUE"));
        }
        ...
        public async Task RequestSerializationError_ClientStreaming()
        {
            ...
            AsyncAssert.ThrowsAsync<IOException>(async () => await call.RequestStream.WriteAsync("UNSERIALIZABLE_VALUE"));
