...
namespace Grpc.IntegrationTesting
{
    ...
    public class Histogram
    {
        ...
        public Histogram(double resolution, double maxPossible)
        {
            ...
            this.oneOnLogMultiplier = 1.0 / System.Math.Log(1.0 + resolution);
        ...
        private int FindBucket(double value)
        {
            ...
            value = System.Math.Min(value, this.maxPossible);
            return (int)(System.Math.Log(value) * oneOnLogMultiplier);
        }
        ...
        private void GetSnapshotUnsafe(HistogramData mergeTo, bool reset)
        {
            ...
            {
                mergeTo.MinSeen = System.Math.Min(mergeTo.MinSeen, min);
                mergeTo.MaxSeen = System.Math.Max(mergeTo.MaxSeen, max);
            }
            mergeTo.Count += count;
            mergeTo.Sum += sum;
