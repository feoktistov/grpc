...
namespace Grpc.Core.Tests
{
    public class ClientServerTest
    {
        ...
        public void UnaryCall_ServerHandlerThrows()
        {
            ...
            var ex2 = AsyncAssert.ThrowsAsync<RpcException>(async () => await Calls.AsyncUnaryCall(helper.CreateUnaryCall(), "abc"));
        ...
        public void ServerStreamingCall_ErrorCanBeAwaitedTwice()
        {
            ...
            var ex = AsyncAssert.ThrowsAsync<RpcException>(async () => await call.ResponseStream.MoveNext());
            ...
            var ex2 = AsyncAssert.ThrowsAsync<RpcException>(async () => await call.ResponseStream.MoveNext());
        ...
        public async Task ClientStreamingCall_CancelAfterBegin()
        {
            ...
            try
            {
                // cannot use AsyncAssert.ThrowsAsync because it uses Task.Wait and would deadlock.
        ...
        public async Task Channel_WaitForStateChangedAsync()
        {
            ...
            AsyncAssert.ThrowsAsync(typeof(TaskCanceledException), 
